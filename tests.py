...
class PartyTests(unittest.TestCase):
    ...
    def test_no_rsvp_yet(self):
        ...
        print "YAY you're not RSVP'd yet"

    def test_rsvp(self):
        result = self.client.post("/rsvp",
                                  data={"name": "Jane",
                                        "email": "jane@jane.com"},
                                  follow_redirects=True) #why is with not included?
    ...
    def setUp(self):
        ...
        with self.client as c:
            with c.session_transaction() as sess:
                sess['RSVP'] = True #placement of setUp
